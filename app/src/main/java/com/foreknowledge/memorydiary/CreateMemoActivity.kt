...
import com.foreknowledge.memorydiary.RequestCode.CHOOSE_CAMERA_IMAGE
import com.foreknowledge.memorydiary.RequestCode.CHOOSE_GALLERY_IMAGE
...
class CreateMemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val webBtn = findViewById<View>(R.id.webBtn) as Button
